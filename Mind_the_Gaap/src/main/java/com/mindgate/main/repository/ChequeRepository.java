...
public class ChequeRepository implements ChequeRepositoryInterface {
	...
	public boolean addNewCheque(Cheque cheque) {
		...
		Object[] parameters = {date, cheque.getAmount(), cheque.getFromAccountId(),
                cheque.getToAccountId(), ClearanceDate, cheque.getChequeStatus() };
	...
	public Cheque updateCheque(Cheque cheque) {
		Object[] parameters = { cheque.getAmount(),

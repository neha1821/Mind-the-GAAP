...
=======
		...
		Customer customer = new Customer(firstName, lastName, username, password, addressLine1, addressLine2,
				addressLine3, city, state, zip, phone, cell, email, customerId, customerStatus);
		...
		Account account = new Account(openingData, minimumBalance, currentBalance, rateOfInterest, accountId,

...
public class TransactionRepository implements TransactionRepositoryInterface {
	...
	private final static String UPDATE_EXISTING_TRANSACTION = "update transactions set date_and_time=?,  type=?, amount=?,account_id=?, to_account_id=?, transaction_status=? where transaction_id=?";
